...
const CartItemList: React.FC<CartItemListProps> = ({
  ...
  <div className="relative flex-1 overflow-y-auto bg-gray-50 p-0.5 divide-y divide-gray-100 z-10" style={{maxHeight:'calc(100vh - 330px)'}}>
    ...
    <div className="absolute left-0 right-0 top-0 bottom-0 flex items-center justify-center pointer-events-none select-none z-0">
      <span className="text-[4vw] font-extrabold text-gray-100 opacity-40 tracking-widest" style={{letterSpacing:'0.2em'}}>SATIŞ</span>
    </div>
